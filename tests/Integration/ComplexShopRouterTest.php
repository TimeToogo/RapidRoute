...
class ComplexShopRouterTest extends RouterTestBase
{
    ...
    public function routerMatchingExamples()
    {
        return [
            ...
            ['POST', '/about-us', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],

            ['GET', '/contact-us', RouterResult::found(['name' => 'contact-us'], [])],
            ['POST', '/contact-us', RouterResult::found(['name' => 'contact-us.submit'], [])],
            ['DELETE', '/contact-us', RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'POST'])],

            ['GET', '/blog', RouterResult::found(['name' => 'blog.index'], [])],
            ['PATCH', '/blog', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['POST', '/blog/post/abc-123-qwerty', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['DELETE', '/shop', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],

            ['GET', '/shop/category', RouterResult::found(['name' => 'shop.category.index'], [])],
            ['PUT', '/shop/category',  RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['PATCH', '/shop/category/123', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['PUT', '/shop/product',  RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['DELETE', '/shop/product/100', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['PATCH', '/shop/cart', RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'PUT', 'DELETE'])],
            ...
            ['HEAD', '/admin/login', RouterResult::found(['name' => 'admin.login'], [])],
            ['PATCH', '/admin/login',  RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'POST'])],
            ...
            ['POST', '/admin/product/create', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ['GET', '/admin/product/1', RouterResult::found(['name' => 'admin.product.show'], ['product_id' => '1'])],
            ['HEAD', '/admin/product/123', RouterResult::found(['name' => 'admin.product.show'], ['product_id' => '123'])],
            ...
            ['PATCH', '/admin/product/1/edit', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['POST', '/admin/product/1', RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'PUT', 'PATCH', 'DELETE'])],
            ['DELETE', '/admin/product/2', RouterResult::found(['name' => 'admin.product.destroy'], ['product_id' => '2'])],
            ['TRACE', '/admin/product/123', RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'PUT', 'PATCH', 'DELETE'])],
            ...
            ['POST', '/admin/category/create', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['PATCH', '/admin/category/1/edit', RouterResult::httpMethodNotAllowed(['GET', 'HEAD'])],
            ...
            ['POST', '/admin/category/1', RouterResult::httpMethodNotAllowed(['GET', 'HEAD', 'PUT', 'PATCH', 'DELETE'])],
