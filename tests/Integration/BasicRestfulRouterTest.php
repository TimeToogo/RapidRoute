...
class BasicRestfulRouterTest extends RouterTestBase
{
    ...
    public function routerMatchingExamples()
    {
        return [
            ...
            ['PUT', '/user', RouterResult::httpMethodNotAllowed(['GET', 'POST'])],

            ['GET', '/user/create', RouterResult::found(['name' => 'user.create'], [])],
            ['DELETE', '/user', RouterResult::httpMethodNotAllowed(['GET', 'POST'])],
            ['PATCH', '/user', RouterResult::httpMethodNotAllowed(['GET', 'POST'])],
            ...
            ['HEAD', '/user/123', RouterResult::httpMethodNotAllowed(['GET', 'PUT', 'DELETE'])],
            ...
            ['PATCH', '/user/1/edit', RouterResult::httpMethodNotAllowed(['GET'])],
            ...
            ['PATCH', '/user/1', RouterResult::httpMethodNotAllowed(['GET', 'PUT', 'DELETE'])],
            ['PATCH', '/user/123321', RouterResult::httpMethodNotAllowed(['GET', 'PUT', 'DELETE'])],
        ];
    }
}